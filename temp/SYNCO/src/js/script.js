...
(function () {
  ...
  $(function () {
          ...
          if ($selectedEvent.hasClass("opened")) {
            ...
            setTimeout(function () {
              $selectedEvent
                .parent()
                .after(
                  "<div class='rdc-calendar-event-panel' id='calendarEvent" +
                    event.data +
                    "'><div class='event-panel'></div></div>"
                );
              eventRow = hiddenEvents
                .clone()
                .appendTo($("#calendarEvent" + event.data + " .event-panel"));
    ...
    //         : ["S", "M", "T", "W", "T", "F", "S"],
    //       months: calendarItem.attr("data-months")
