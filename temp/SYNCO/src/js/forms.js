  ...
  (() => {
    ...
    function t(e) {
      ...
      "err" == e.status
        ...
        : ((t = "success"), (n = e.msg)),
        r.attr("class", "output text-white text-center card bg-" + t).html(n);
    }
    e("form").on("submit", function (n) {
      n.preventDefault();
      var r = e(n.currentTarget).find("input, textarea"),
        i = [],
        o = e(n.currentTarget).find("button");
      // r.each(function (e) {
      //   var t,
      //     n,
      //     o = r[e];
      ...
      //   ))
      //     ? "phone" != o.name || ((t = o.value), /^[0-9]{10}/.test(t))
      //       ? "message" == o.name &&
      //         o.value.length <= 10 &&
      //         i.push("Please write more on your message")
      //       : i.push("Phone isn't valid")
      //     : i.push("Email isn't valid");
      // });
      r.each(function (e) {
        var t,
          n,
          o = r[e];
        // Skip the phone validation by removing the block for the phone field
        if (
          "email" != o.name ||
          ((n = o.value),
          /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(
          ...
          // Remove the following phone validation code
          /*
          if ("phone" != o.name || ((t = o.value), /^[0-9]{10}/.test(t)))
            ? "message" == o.name && o.value.length <= 10 && i.push("Please write more on your message")
            : i.push("Phone isn't valid");
          */
          // You can keep the message validation here if required
          if ("message" == o.name && o.value.length <= 10) {
            i.push("Please write more on your message");
          }
        } else {
          i.push("Email isn't valid");
      ...
      var a = "/post_c";
      switch (n.currentTarget.getAttribute("portal")) {
        case "singup":
          a = "/post_su";
          break;
        case "login":
                ...
                success: (n) => {
                  "refresh" === n
                    ...
                    : (r.removeAttr("disabled"),
                      t({ status: "suc", msg: n, target: e(o) }));
                },
                error: (n) => {
                  r.removeAttr("disabled"),
                    t({ status: "err", msg: n.responseText, target: e(o) });
                },
              });
          })(new FormData(n.currentTarget), o, a, n.currentTarget)
        : t({ status: "err", msg: i, target: e(n.currentTarget) });
    }),
      document.addEventListener("DOMContentLoaded", function () {
        var messageTextarea = document.querySelector(
    ...
    e("[portal-del]").click(function () {
      e.ajax({
        ...
        error: (n) => {
          t({ status: "err", msg: n.responseText, target: e(".output") });
        },
      });
    });
  })();
